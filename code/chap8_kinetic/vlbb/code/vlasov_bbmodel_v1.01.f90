...
!*              vlasov_bbmodel_v1.01.f90, 2011-08-26 07:15                         *
!*        Hua-sheng XIE, IFTS-ZJU, huashengxie@{gmail.com, zju.edu.cn}             *
!***********************************************************************************

module variable
	implicit real*8 (A-H,O-Z)
	integer :: stdout=0, method_efield=2, method_vlasov=2
	...
	real*8 :: gammad=1.0d0, mua=0.012589
	! gammad: damping rate for BB model
	! mua: Krook collison for BB model
	integer,parameter :: m=63, n=64, nt=60000, nplot=1000, ndiag=1
	...
	real*8,parameter :: alpha=0.001d0, fbeam=1.0
