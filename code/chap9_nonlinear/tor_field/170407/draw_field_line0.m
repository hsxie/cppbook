...
% R0=3;a=1;kappa=1.5;delta=0.5;b=0.0;n=1; m=3; 
% R0=3;a=2.7;kappa=1.5;delta=0.5;b=0.0;n=1; m=5; 
R0=3;a=0.5;kappa=1.5;delta=0.5;b=0.0;n=15; m=1; 
...
q=m/n; strtitle=['B Field Line, q=m/n=',num2str(m),'/',num2str(n),', R0=',...
...
z=(kappa*a).*sin(theta2); hold on; plot3(x,y,z,'r','LineWidth',2);
